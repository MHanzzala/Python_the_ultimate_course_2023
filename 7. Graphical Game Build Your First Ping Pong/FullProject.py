...
scoreText.write("Player_1: 0  Player_2: 0", align="center", font=("Time New Roman",22,"normal"))
step = 10
...
while(1):
    ...
    if ball.xcor()>=350:
        score1 = score1 +1
        scoreText.clear()
        scoreText.write("Player 1 : {}  Player 2 : {}".format(score1,score2), align="center", font=("Time New Roman",22,"normal"))
        ball.goto(0,0)
        ball.dx = ball.dx *-1
